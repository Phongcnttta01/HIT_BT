...
namespace MoreMountains.Tools
{
	...
	public class MMCinemachineZone2D : MMCinemachineZone
	{
		...
		{
			CompositeCollider2D compositeCollider = _confinerGameObject.GetComponent<CompositeCollider2D>();
			if (compositeCollider == null)
			{
				compositeCollider = _confinerGameObject.AddComponent<CompositeCollider2D>();
			}
			...
			if (_boxCollider2D != null)
			{
				...
				boxCollider2D.usedByComposite = true;  // Quan trọng!
			}
			...
			if (_circleCollider2D != null)
			{
				...
				circleCollider2D.usedByComposite = true;  // Quan trọng!
			}
			...
			if (_polygonCollider2D != null)
			{
				...
				polygonCollider2D.usedByComposite = true;  // Quan trọng!
			}
		}
